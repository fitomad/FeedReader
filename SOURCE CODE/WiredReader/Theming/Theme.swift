...
//  WiredReader
//
//  Created by Adolfo Vera Blasco on 7/8/17.
	...
	*/
	private func applyMode() -> Void
	{
		switch self.mode
        {
            ...
            case .light: 
                self.backgroundColor = UIColor.color(from: "#ffffff", alpha: 1.0)
                self.secondaryBackgroundColor = UIColor.color(from: "#f9f9f9", alpha: 1.0)
                self.textColor = UIColor.color(from: "#121212", alpha: 1.0)
